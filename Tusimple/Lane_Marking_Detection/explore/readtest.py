...
img_root = '/media/zyzhong/Data/data3/XJTU2017/task_1/TSD-Lane/TSD-Lane-00096/'
img_xml  = '/media/zyzhong/Data/data3/XJTU2017/task_1/TSD-Lane-GT/TSD-Lane-00096-GT.xml'
...
import codecs
import io
f = codecs.open(img_xml, 'r', encoding = 'GBK')
